...
entity hsys_top_bram_0_avalon_slave_0_translator_avalon_universal_slave_0_agent is
	generic (
		...
		PKT_ADDR_H                : integer := 52;
		PKT_ADDR_L                : integer := 36;
		PKT_TRANS_COMPRESSED_READ : integer := 53;
		PKT_TRANS_POSTED          : integer := 54;
		PKT_TRANS_WRITE           : integer := 55;
		PKT_TRANS_READ            : integer := 56;
		PKT_TRANS_LOCK            : integer := 57;
