...
entity hsys_width_adapter is
	generic (
		...
		OUT_PKT_ADDR_H                : integer := 88;
		OUT_PKT_ADDR_L                : integer := 72;
		OUT_PKT_DATA_H                : integer := 63;
		OUT_PKT_DATA_L                : integer := 0;
		OUT_PKT_BYTEEN_H              : integer := 71;
		OUT_PKT_BYTEEN_L              : integer := 64;
		OUT_PKT_BYTE_CNT_H            : integer := 98;
		OUT_PKT_BYTE_CNT_L            : integer := 95;
		OUT_PKT_TRANS_COMPRESSED_READ : integer := 89;
		OUT_PKT_BURST_SIZE_H          : integer := 104;
		OUT_PKT_BURST_SIZE_L          : integer := 102;
		OUT_PKT_RESPONSE_STATUS_H     : integer := 122;
		OUT_PKT_RESPONSE_STATUS_L     : integer := 121;
		OUT_PKT_TRANS_EXCLUSIVE       : integer := 94;
		OUT_PKT_BURST_TYPE_H          : integer := 106;
		OUT_PKT_BURST_TYPE_L          : integer := 105;
