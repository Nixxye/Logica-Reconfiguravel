...
entity hsys_memory_s1_translator_avalon_universal_slave_0_agent is
	generic (
		...
		PKT_BEGIN_BURST           : integer := 109;
		PKT_SYMBOL_W              : integer := 8;
		PKT_BYTEEN_H              : integer := 71;
		PKT_BYTEEN_L              : integer := 64;
		PKT_ADDR_H                : integer := 88;
		PKT_ADDR_L                : integer := 72;
		PKT_TRANS_COMPRESSED_READ : integer := 89;
		PKT_TRANS_POSTED          : integer := 90;
		PKT_TRANS_WRITE           : integer := 91;
		PKT_TRANS_READ            : integer := 92;
		PKT_TRANS_LOCK            : integer := 93;
		PKT_SRC_ID_H              : integer := 111;
		PKT_SRC_ID_L              : integer := 111;
		PKT_DEST_ID_H             : integer := 112;
		PKT_DEST_ID_L             : integer := 112;
		PKT_BURSTWRAP_H           : integer := 101;
		PKT_BURSTWRAP_L           : integer := 99;
		PKT_BYTE_CNT_H            : integer := 98;
		PKT_BYTE_CNT_L            : integer := 95;
		...
		PKT_BURST_SIZE_H          : integer := 104;
		PKT_BURST_SIZE_L          : integer := 102;
	...
	port (
		...
		m0_address              : out std_logic_vector(16 downto 0);                     --              m0.address
