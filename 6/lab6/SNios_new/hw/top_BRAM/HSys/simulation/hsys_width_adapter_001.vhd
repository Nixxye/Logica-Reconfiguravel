...
entity hsys_width_adapter_001 is
	generic (
		IN_PKT_ADDR_H                 : integer := 88;
		IN_PKT_ADDR_L                 : integer := 72;
		IN_PKT_DATA_H                 : integer := 63;
		IN_PKT_DATA_L                 : integer := 0;
		IN_PKT_BYTEEN_H               : integer := 71;
		IN_PKT_BYTEEN_L               : integer := 64;
		IN_PKT_BYTE_CNT_H             : integer := 98;
		IN_PKT_BYTE_CNT_L             : integer := 95;
		IN_PKT_TRANS_COMPRESSED_READ  : integer := 89;
		IN_PKT_BURSTWRAP_H            : integer := 101;
		IN_PKT_BURSTWRAP_L            : integer := 99;
		IN_PKT_BURST_SIZE_H           : integer := 104;
		IN_PKT_BURST_SIZE_L           : integer := 102;
		IN_PKT_RESPONSE_STATUS_H      : integer := 122;
		IN_PKT_RESPONSE_STATUS_L      : integer := 121;
		IN_PKT_TRANS_EXCLUSIVE        : integer := 94;
		IN_PKT_BURST_TYPE_H           : integer := 106;
		IN_PKT_BURST_TYPE_L           : integer := 105;
